    ...
    public void selectuser(int position) {
       selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        ...
        while(cursor.moveToNext()) {
            ...
            new DatabaseHelper(this).insertTransferData(date, name, selectuser_name, transferamount, " Payment Success");
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(sendtouser.this).insertTransferData(date, name, "None", transferamount, "Payment Failed");
